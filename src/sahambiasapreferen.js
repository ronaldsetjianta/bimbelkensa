...
function SahamBiasaPreferenPage() {
  ...
  const answerKeyHTML = `
    Quiz<br>
    1.&nbsp;&nbsp;Jika kita membeli saham Bank BCA (BBCA) di bursa saham melalui aplikasi online, itu tergolong jenis saham yang mana?<br>
    2.&nbsp;&nbsp;Seorang investor berorientasi pada pendapatan dan perlindungan modal untuk jangka panjang. Jenis saham mana yang lebih cocok?<br>
    `;
