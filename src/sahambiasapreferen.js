...
function SahamBiasaPreferenPage() {
  ...
  // PERUBAHAN: MENGAMBIL isAuthLoading
  ...
  const fetchComments = useCallback(async () => {
    ...
    const commentsById = {};
    let topLevelComments = []; // Dibuat let agar bisa di-sort
  ...
  // FUNGSI 'Edit' (Masuk ke mode edit) - Dikembalikan ke bentuk original
  ...
  const handleCommentSubmit = async (e) => {
    e.preventDefault();
    // PERBAIKAN: Validasi user dan user.id
  ...
  // PENANGANAN LOADING: Tampilkan Loading jika status autentikasi belum jelas
  if (isAuthLoading) {
    return (
      ...
      <section ref={commentRef} id="kolom-komentar" className={`kolom-komentar ${commentVisible ? "animate" : ""}`}>
        <div className="container">
          ...
          <div className="comment-list">
            {/* Urutan di sini sudah DESCENDING berkat sorting di fetchComments() */}
                ...
                <div key={comment.id} className="comment-item">
                  <p className="comment-author">
                    ...
                    <span style={{
                        ...
                        fontWeight: 'normal', 
                        color: '#6c757d',
                        marginLeft: '10px', // Jarak 10px
                        verticalAlign: '1.1px' // Posisi vertikal +1.1px
                    }}>
                    ...
                    <form className="reply-form" onSubmit={(e) => handleReplySubmit(e, comment.id)}>
                      ...
                      <div>
                        ...
                        <button
                          ...
                          onClick={() => {
                            setReplyingTo(null);
                            setReplyText(''); // Clear isi kolom komentar
                          }}
                        >
                          Batal
                        </button>
