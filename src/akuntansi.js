    ...
    <>
      ...
      <section ref={heroRef} id="subject-hero" className={`subject-hero ${heroVisible ? "animate" : ""}`}>
        <div className="container">
          <img src="/images/logo_akuntansi.png" alt="Logo Akuntansi" className="subject-hero-logo" />
      ...
      <section ref={listRef} id="daftar-materi" className={`daftar-materi ${listVisible ? "animate" : ""}`}>
        <div className="container">
          <div className="materi-grid">
            <Link to="/sahambiasapreferen" ref={item1Ref} className={`materi-item ${item1Visible ? 'animate' : ''}`}>
